        ...
        <div class="table-container">
            <div class="table-header-content">
                ...
                <a href="{{ route('laporan.penjualan.transaksi', ['tanggal' => $penjualan->tanggal]) }}"
                    class="btn-back" id="btnBackToTransaksi" title="Kembali">
                ...
                <tbody>
                    @foreach ($rincianBarang as $index => $item)
                        <tr>
                            ...
                            <td class="col-det-nama">{{ $item->barang->nama_barang ?? 'Barang Tidak Diketahui' }}</td>
                            ...
                            <td class="col-det-profit">Rp
                                {{ number_format(($item->harga - $item->modal) * $item->jumlah, 0, ',', '.') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
